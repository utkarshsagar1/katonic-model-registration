...
mlflow.set_tracking_uri("http://asa-9eb5c81e-515e-4b65-a5c9-a3dd04345f3c.kt-wast-app.svc.cluster.local:80")
# ----------------------------------------------------------------------------------
...
with mlflow.start_run(run_name="Model_Registration_Run") as run: # Changed run_name slightly for clarity
